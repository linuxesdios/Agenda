              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    const Divider(),
                    SwitchListTile(
                      title: Text('⚫ ${estado.t('ajustes.widget_fondo_negro')}'),
                      subtitle: Text(estado.t('ajustes.widget_fondo_negro_sub')),
                      value: estado.widgetFondoNegro,
                      onChanged: (v) => estado.cambiarWidgetFondoNegro(v),
                    ),
                    ListTile(
                      contentPadding: EdgeInsets.zero,
                      title: Text(estado.t('ajustes.widget_max_items')),
                      subtitle: Text('${estado.widgetMaxItems}'),
                    ),
                    Slider(
                      value: estado.widgetMaxItems.toDouble(),
                      min: 2,
                      max: 8,
                      divisions: 6,
                      label: '${estado.widgetMaxItems}',
                      onChanged: (v) => estado.cambiarWidgetMaxItems(v.round()),
                    ),
                  ],
                ),
              ),
